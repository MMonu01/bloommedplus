...
return(
    <div>
        ...
        color:"black" }} > Popular Combo categories </h3>
    <div className={styles.box}>
        <div onClick={buttonPressRev}><FontAwesomeIcon  className={styles.icon} icon={faChevronLeft}/></div>
    <div className={styles.container} style={{width:"100%"}}>
        <div   id="pc2"  style={{scrollBehavior:"smooth",background:"white" }}>
        {
            loading===false ? data.map((el)=>(
                <div  key={el.id} style={{ height:"270px",fontSize:"14px",padding:"10px",
                 background:"white"  }}>
